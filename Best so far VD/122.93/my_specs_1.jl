...
e = [3.27,1.98,1.34,1,0.72] # Enter your 5 or 6 gear ratios here, starting from _first_ gear, i.e., in the default values, 1st gear is 5.0:1, note that the defaults are a poor choice
ex = 3.76 # Enter your axle final drive ratio here
...
# driver model
acc_max = 0.665# [g's] maximum acceleration, used to compute target speeds based on track curvature